...
class Pagination {
    ...
    private function generateHtml($page, $text = null) {
        ...
        {
            return '<li class="page-item"><a class="page-link" href="/skills/'.$page.'">'.$text.'</a></li>';
        }
        return '<li class="page-item"><a class="page-link" href="/skills/'.$this->route['controller'].'/'.$this->route['action'].'/'.$page.'">'.$text.'</a></li>';
